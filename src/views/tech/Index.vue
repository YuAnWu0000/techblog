  ...
  <div class="page">
    <el-row style="width: 100%;">
      ...
      <el-col :span="24">
        <div>最新文章</div>
        <div
          style="display: flex; flex-direction: column; flex-wrap: wrap; justify-content: center; max-height: 400px;"
        >
          <div v-for="article in articles" :key="article.number" style="width: 400px;">
            ...
            <!-- 小圖文章們 -->
            <div v-else class="article-wrapper" style="display: flex;">
      ...
      <el-col :span="12">
        <el-row v-for="ramen in ramens" :key="ramen.id" style="display:flex; margin-bottom: 10px;">
          <el-col
            :span="6"
            class="ramen-img"
            :style="{ backgroundImage: 'url(' + ramen.imgSrc1 + ')' }"
          ></el-col>
          <el-col :span="18">
            <el-rate
